...
**v3 shipped 2026-09-09 — `package.json` is `0.3.0`.** All seven phases of `plan/plan-r2p-v3` are done and every researcher decision is answered. **Current focus: nothing.** The plan is awaiting the researcher's confirmation to write `.completed` and hand to the archivist.
